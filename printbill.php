...
if ($result1){
     $sql2 = "UPDATE cars c, rentedcars rc SET c.car_availability='yes' WHERE rc.car_id=c.car_id AND rc.customer_username = '$login_customer' AND rc.id = '$id'";
...
?>
    ...
    <h2 class="text-center"> Thank you for visiting Adiss Car Rentals! We wish you have a safe ride. </h2>
