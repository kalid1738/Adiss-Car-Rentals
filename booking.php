    ...
    <div class="col-md-7" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <div ng-switch-default>
                ...
                <h5>Fare: <b><?php echo("br. " . $ac_price . "/km and br. " . $ac_price_per_day . "/day");?></b><h5>    
               
                     </div>
                     <div ng-switch-when="non_ac">
                    
                <h5>Fare: <b><?php echo("br. " . $non_ac_price . "/km and br. " . $non_ac_price_per_day . "/day");?></b><h5>    
      ...
      <div class="col-md-12" style="float: none; margin: 0 auto; text-align: center;">
            <h6><strong>Note:</strong> You will be charged with extra <span class="text-danger">br. 300</span> for each day after the due date ends.</h6>
        </div>
    </div>
