...
<?php
    ...
    $sql4 = "SELECT * FROM  cars c, clients cl, rentedcars rc WHERE c.car_id = '$car_id' AND cl.client_username = cl.client_username";
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for using Adiss Car Rental System! We wish you have a safe ride. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            <div class="col-md-10" style="float: none; margin: 0 auto; ">
                ...
                if($charge_type == "days"){
                ?>
                     <h4> <strong>Fare:</strong> br. <?php echo $fare; ?>/day</h4>
                <?php } else {
                    ?>
                    <h4> <strong>Fare:</strong> br. <?php echo $fare; ?>/km</h4>
