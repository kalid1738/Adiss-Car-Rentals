...
function dateDiff($start, $end) {
 ...
 $id = $_GET["id"];
 $sql1 = "SELECT c.car_name, c.car_nameplate, rc.rent_start_date, rc.rent_end_date, rc.fare, rc.charge_type FROM rentedcars rc, cars c WHERE id = '$id' AND c.car_id=rc.car_id ";
