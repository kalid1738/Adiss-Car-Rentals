                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color:black">ADISS CAR RENTALS</h1>
                            <p class="intro-text">
                             <b>
...
<br>
        <section class="menu-content">
            ...
            <h6> AC Fare: <?php echo ("br. " . $ac_price . "/km & br." . $ac_price_per_day . "/day"); ?></h6>
            <h6> Non-AC Fare: <?php echo ("br. " . $non_ac_price . "/km & br." . $non_ac_price_per_day . "/day"); ?></h6>
